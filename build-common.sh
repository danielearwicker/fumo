tsc --noImplicitAny --module commonjs index.ts fumo.d.ts lib/node.d.ts lib/selenium-webdriver.d.ts lib/selenium-webdriver-helpers.d.ts lib/knockout.d.ts lib/stacktrace.d.ts
rm ../fumo.nw
